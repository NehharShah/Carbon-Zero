...
contract CarbonZero is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CNZ() {
        uint256 total_coins = 1000000000000 * 10 ** uint256(18);
        ...
        name = "CarbonZero";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CNZ";                                             // Set the symbol for display purposes (CHANGE THIS)
